 ...
 * `value?: string`으로 좁혀져 있어, 실제 클래스 필드(`value?: unknown`)와 JSDoc이 명시하는
 * `null`·숫자 입력을 TS strict 소비자가 그대로 못 넘겼다(docket #183) — 순수 **타입** 실패라
...
/** 회귀 — `value`가 `null`·숫자를 그대로 받는다(원 재현: yesung-oms 6화면 40호출부) */
